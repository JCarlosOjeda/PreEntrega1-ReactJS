...
const Checkout = () => {
    ...
    const generarOrden = () => {
        ...
        const items = cart.map(item => ({ id: item.id, title: item.titulo, price: item.precio, cantidad: item.cantidad }));
    ...
    return (
        <div className="container my-5 card bg-light">
            <div className="row">
                <div className="col-md-4 offset-md-1 fw-bold">
                    <form>
                        <div className="mb-3">
                        ...
                        <button type="button" className="btn bg-success-subtle fw-bold fs-5 " onClick={generarOrden}>Generar Orden</button>
                    </form>
                </div>
                <div className="col-md-5 offset-md-2">
                    <table className="table">
                        <tbody>
                            ...
                            <tr>
                                <td colSpan={3} className="align-middle text-end fw-bold">Total a Pagar</td>
